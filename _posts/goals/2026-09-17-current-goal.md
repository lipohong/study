...
permalink: /goals/current-goal/
categories: [goals]
tags: [learning, goals, planning]
description: "goals record: Current Goal."
comments: false
toc: true
language: en
...
> **Chinese version:** [/zh-hant/goals/current-goal/](/zh-hant/goals/current-goal/)


> Keep **one primary goal** active. A clear goal makes LLM guidance specific rather than generic.
...
- **What I can already do:**
  - Distinguish recalling a formula from reasoning with it under fixed conditions.
  - Use a simple causal relation (`a = F/m`, when net force is fixed) to compare outcomes.
  - Identify that a claim may omit variables and conditions, rather than treating one factor as the entire cause.
- **Recent example / attempt:** In discussion, I explained that study time is only one of many factors influencing performance.
- **What feels difficult or confusing:** The exact boundary between being able to explain, predict, apply, and genuinely understand remains to be tested in unfamiliar cases.
- **Constraints (time, energy, tools, language):** Short, one-question-at-a-time guided practice; Cantonese may be used for the learner's own reasoning, while technical terms can remain in English when useful.
...
- Learner context: [Learner Profile](/context/learner-profile/)
- Current state: [Current Learning State](/context/learning-state/)
- Breakdown: [Goal Breakdown](/goals/breakdown/)
- Session thinking: [Thinking: What counts as understanding?](/thinking/understanding/)
