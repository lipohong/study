...
- [ ] 解釋 workspace 的修正：知識是學習者構建、可修訂的世界模型；筆記、書籍、數據和 LLM 回應則是外在模型資源。
...
- [ ] 解釋為何學習能力受任務影響，不應被視為單一固定引擎。
- [ ] 把一個學習瓶頸診斷為缺少模型、認知負荷、練習不足，或策略選擇。
- [ ] 選擇一項策略、界定即時和延遲量度，並說出哪個結果會修訂計劃。
- [ ] 在不看筆記下完成 [練習：診斷及改進學習能力](/zh-hant/practice/drills/learning-ability-diagnosis/)。
