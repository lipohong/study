...
**我想要的成果：** 建立一個可用模型：知識是學習者所構建、可修訂的世界模型；區分外在模型資源與知識，並且不混淆知識、理解、認知支援、技能和 mastery。

## 第一個具體目標

- **技能／主題：** 分析世界模型或主張的品質；區分世界事件、外在表徵和內在模型關係；區分認知支援與理解能力；並區分理解與不同精通層級。
- **為何現在重要：** 我想主動學習，而非誤把外在筆記、記住的規則、流暢的解釋或強記憶力當作已檢驗的內在模型和真正的理解。
- **截至日期可觀察到的表現：** 在下次回顧前，獨立分析三個陌生的日常主張。對每個主張，區分世界事件、相關外在表徵和要構建的內在關係；指出相關條件／變數；對已改變的個案作出預測；說明甚麼會要求修訂模型；說明甚麼證據可展現理解；判斷困難主要是認知支援問題、知識／模型問題或兩者兼有，並把證據分類為辨識、解釋、有引導的應用、獨立熟練、遷移或教學／創作。
- **截止／回顧日期：** 2026-09-17
...
- [ ] 在不看筆記下，用一個原創日常例子區分世界事件、外在表徵、內在模型關係、它支持的預測，以及會修訂它的證據。
